...
public interface ProductRepository extends JpaRepository<Product, Integer> {
	...
	@Query("SELECT distinct new com.project.dtos.CatalogDto(c.type, b.id, c.id) FROM Product p JOIN p.catalog c JOIN p.brand b where b.id = :brand_id")
	List<CatalogDto> getCatalogByBrand(@Param("brand_id") Integer id);
